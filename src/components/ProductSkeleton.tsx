...
const ProductSkeleton = () => {
	return (
		<div
			role='status'
			className='max-w-sm p-4  rounded-lg shadow-[0_3px_25px_5px_rgb(150,150,150,.5)] animate-pulse md:p-6'>
			<div className='flex items-center justify-center h-48 mb-4 bg-gray-300 rounded-lg dark:bg-gray-400'>
				<svg
			...
			<div>
				<div className='h-8 bg-gray-200 rounded-full dark:bg-gray-400 w-full mb-2'></div>
			</div>
